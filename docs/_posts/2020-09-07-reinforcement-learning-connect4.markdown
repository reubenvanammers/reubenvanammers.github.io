...
In this post, I'll be talking a bit about techniques in reinforcemnt learning, an overview of AlphaGo, how I implemented an algorithm similar to it in the game of Connect 4, and what the results were. 
